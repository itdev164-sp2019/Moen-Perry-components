...
var IconButton = (0, _styledComponents.default)(function (_ref) {
  var icon = _ref.icon,
      props = _objectWithoutProperties(_ref, ["icon"]);

  var clone = _react.default.cloneElement.apply(_react.default, [icon].concat(_toConsumableArray(props)));
